...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: BiddingWidget.routeName,
          path: BiddingWidget.routePath,
          builder: (context, params) => BiddingWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: ChangeMobilePinWidget.routeName,
          path: ChangeMobilePinWidget.routePath,
          builder: (context, params) => ChangeMobilePinWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: UnpaidWidget.routeName,
          path: UnpaidWidget.routePath,
          builder: (context, params) => UnpaidWidget(),
        ),
        FFRoute(
          name: ShippedWidget.routeName,
          path: ShippedWidget.routePath,
          builder: (context, params) => ShippedWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: TrackingDetailsWidget.routePath,
          builder: (context, params) => TrackingDetailsWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: BidsWidget.routeName,
          path: BidsWidget.routePath,
          builder: (context, params) => BidsWidget(),
        ),
        FFRoute(
          name: ReturnedWidget.routeName,
          path: ReturnedWidget.routePath,
          builder: (context, params) => ReturnedWidget(),
        ),
        FFRoute(
          ...
          asyncParams: {
            'addressRef':
                getDoc(['users', 'address'], AddressRecord.fromSnapshot),
          },
        ...
        FFRoute(
          name: ChangeFullNameWidget.routeName,
          path: ChangeFullNameWidget.routePath,
          builder: (context, params) => ChangeFullNameWidget(),
        ),
        FFRoute(
          name: AddressBookWidget.routeName,
          path: AddressBookWidget.routePath,
          builder: (context, params) => AddressBookWidget(),
        ),
        FFRoute(
          name: ProductListingForBiddingSaleWidget.routeName,
          path: ProductListingForBiddingSaleWidget.routePath,
          builder: (context, params) => ProductListingForBiddingSaleWidget(),
        ),
        FFRoute(
          name: ProductListingForSaleWidget.routeName,
          path: ProductListingForSaleWidget.routePath,
          builder: (context, params) => ProductListingForSaleWidget(),
        ),
        FFRoute(
          name: ProductDetailsSellWidget.routeName,
          path: ProductDetailsSellWidget.routePath,
          builder: (context, params) => ProductDetailsSellWidget(
        ...
        FFRoute(
          name: ProductDetailsBidWidget.routeName,
          path: ProductDetailsBidWidget.routePath,
          builder: (context, params) => ProductDetailsBidWidget(
        ...
        FFRoute(
          name: ProductDetailSellWidget.routeName,
          path: ProductDetailSellWidget.routePath,
          builder: (context, params) => ProductDetailSellWidget(),
        ),
        FFRoute(
          name: ProductDetailBidWidget.routeName,
          path: ProductDetailBidWidget.routePath,
          builder: (context, params) => ProductDetailBidWidget(),
        ),
        FFRoute(
