...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF014063);
  late Color secondary = const Color(0xFF057BBC);
  late Color tertiary = const Color(0xFFE9ECEF);
  late Color alternate = const Color(0xFFC5C9CC);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF818585);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFE9ECEF);
  late Color accent1 = const Color(0xFFFFD600);
  late Color accent2 = const Color(0xFF17A2B8);
  late Color accent3 = const Color(0xFFFF6F61);
  late Color accent4 = const Color(0xFF6F42C1);
