  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final verifyUsersRecord = snapshot.data!;
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await VerifiedDetailsRecord.createDoc(
                                  verifyUsersRecord.reference)
                              .set(createVerifiedDetailsRecordData(
                            idType: _model.dropDownValue1,
                            idPhoto: _model.uploadedFileUrl,
                            idNumber: _model.textController1.text,
                            firstName: _model.textController2.text,
                            middleName: _model.textController3.text,
                            lastName: _model.textController4.text,
                            placeBirth: _model.textController5.text,
                            nationality: _model.dropDownValue2,
                            city: _model.textController6.text,
                            province: _model.textController7.text,
                            barangayMunicipality: _model.textController8.text,
                            zipCode: int.tryParse(_model.textController9.text),
                          ));

                          await verifyUsersRecord.reference
                              .update(createUsersRecordData(
                            isSeller: true,
                          ));

                          context.pushNamed(VerifyMessageWidget.routeName);
                        },
                        text: 'Verify',
