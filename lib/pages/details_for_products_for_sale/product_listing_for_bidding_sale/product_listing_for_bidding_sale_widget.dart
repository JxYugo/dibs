...
export 'product_listing_for_bidding_sale_model.dart';

/// done backend
class ProductListingForBiddingSaleWidget extends StatefulWidget {
  const ProductListingForBiddingSaleWidget({super.key});

  static String routeName = 'product_listing_for_bidding_sale';
  static String routePath = '/productListingForBiddingSale';

  @override
  State<ProductListingForBiddingSaleWidget> createState() =>
      _ProductListingForBiddingSaleWidgetState();
}

class _ProductListingForBiddingSaleWidgetState
    extends State<ProductListingForBiddingSaleWidget> {
  late ProductListingForBiddingSaleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductListingForBiddingSaleModel());
    ...
    _model.goalBidTextController ??= TextEditingController();
    _model.goalBidFocusNode ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final productListingForBiddingSaleUsersRecord = snapshot.data!;
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        TextFormField(
                                          controller:
                                              _model.goalBidTextController,
                                          focusNode: _model.goalBidFocusNode,
                                          autofocus: false,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            hintText: '0',
                                          ...
                                          validator: _model
                                              .goalBidTextControllerValidator
                                              .asValidator(context),
                                        ),
                                      ],
                                    ),
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  FlutterFlowDropDown<String>(
                                    controller:
                                        _model.selectSizeValueController ??=
                                  ...
                                  FlutterFlowDropDown<String>(
                                    controller:
                                        _model.selectQualityValueController ??=
                                            FormFieldController<String>(null),
                                    options: ['Good', 'Bad'],
                                    onChanged: (val) => safeSetState(
                                        () => _model.selectQualityValue = val),
                                    width: double.infinity,
                                    height: 50.0,
                                    textStyle: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                  ...
                                  FlutterFlowDropDown<String>(
                                    controller:
                                        _model.selectCategoryValueController ??=
                                            FormFieldController<String>(null),
                                    options: ['Tshirts', 'Dresses', 'Pants'],
                                    onChanged: (val) => safeSetState(
                                        () => _model.selectCategoryValue = val),
                                    width: double.infinity,
                                    height: 50.0,
                                    textStyle: FlutterFlowTheme.of(context)
                                        .bodyMedium
