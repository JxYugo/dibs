...
import 'product_listing_for_sale_model.dart';
export 'product_listing_for_sale_model.dart';

/// done backend
class ProductListingForSaleWidget extends StatefulWidget {
  const ProductListingForSaleWidget({super.key});

  static String routeName = 'product_listing_for_sale';
  static String routePath = '/productListingForSale';

  @override
  State<ProductListingForSaleWidget> createState() =>
      _ProductListingForSaleWidgetState();
}

class _ProductListingForSaleWidgetState
    extends State<ProductListingForSaleWidget> {
  late ProductListingForSaleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductListingForSaleModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final productListingForSaleUsersRecord = snapshot.data!;
                                ...
                                onPressed: () async {
                                  await ProductsRecord.collection.doc().set({
                                    ...createProductsRecordData(
                                      ...
                                      sellerId:
                                          productListingForSaleUsersRecord.uid,
