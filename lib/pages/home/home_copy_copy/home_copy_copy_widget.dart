...
class HomeCopyCopyWidget extends StatefulWidget {
  ...
  static String routeName = 'homeCopyCopy';
  static String routePath = '/homeCopyCopy';
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      admob.loadInterstitialAd(
        "",
        "ca-app-pub-6978288707149884/5186239843",
        true,
      );
    });
                      ...
                      children: [
                        Align(
                          ...
                          child: TabBar(
                            ...
                            indicatorColor: Color(0xFF014063),
                            tabs: [
                              Tab(
                                text: 'All',
                              ),
              ...
              child: Row(
                ...
                children: [
                  FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      context.pushNamed(HomeCopyCopyWidget.routeName);
                    },
                  ),
                  FlutterFlowIconButton(
                    borderRadius: 25.0,
