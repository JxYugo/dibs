...
class BiddingWidget extends StatefulWidget {
  const BiddingWidget({super.key});

  static String routeName = 'bidding';
  static String routePath = '/bidding';
...
class _BiddingWidgetState extends State<BiddingWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BiddingModel());
  }
            ...
            children: [
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: Text(
                    'You\'re now in the running for this item. We\'ll notify you if someone outbids you. ',
