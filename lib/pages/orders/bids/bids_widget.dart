...
class BidsWidget extends StatefulWidget {
  ...
  static String routeName = 'bids';
  static String routePath = '/bids';
                ...
                Column(
                  ...
                  children: [
                    ...
                    Column(
                      mainAxisSize: MainAxisSize.max,
                      children: [
                        StreamBuilder<List<BidsMadeRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<BidsMadeRecord> listViewBidsMadeRecordList =
                                snapshot.data!;
                            if (listViewBidsMadeRecordList.isEmpty) {
                              return Center(
                            ...
                            return ListView.builder(
                              ...
                              itemCount: listViewBidsMadeRecordList.length,
                              itemBuilder: (context, listViewIndex) {
                                final listViewBidsMadeRecord =
                                    listViewBidsMadeRecordList[listViewIndex];
                                return Padding(
                                  padding: EdgeInsets.all(8.0),
                                  child: StreamBuilder<ProductsRecord>(
                                    stream: ProductsRecord.getDocument(
                                        listViewBidsMadeRecord.productId!),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      if (!snapshot.hasData) {
                                        return Center(
                                      ...
                                      return InkWell(
                                        ...
                                        onTap: () async {
                                          context.pushNamed(
                                            ProductDetailsBidWidget.routeName,
                                            queryParameters: {
                                              'productReference':
                                                  serializeParam(
