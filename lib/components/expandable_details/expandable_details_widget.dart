...
import 'expandable_details_model.dart';
export 'expandable_details_model.dart';
...
class _ExpandableDetailsWidgetState extends State<ExpandableDetailsWidget> {
  late ExpandableDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ExpandableDetailsModel());
  }
